...
function VBModules (rootEl)
{
    ...
    this.showModule = function (module, title, e) {
        ...
        if (window.userSetup.general.useTabs)
        {
            ...
            document.getElementById(this.rootElement).appendChild(newDiv);
        }
        ...
        function loadEmbeddedModule (id, embeddableModuleSrc, props) {
            ...
            fetch ("modules/" + path + "/" + file + ".html").then(function (response) { return response.text(); }).then(function (html) {
                ...
                templateHTML = scanForChildModules(templateHTML, embeddableModuleSrc);
                ...
                function startEmbeddedModule () {
                    ...
                    // console.log("starting embedded " + instanceNum + ":" + id + "<" + props.eid + ">");
        ...
        function scanForChildModules (tmplt, pModuleInstanceId)
        {
            let embeddedModules = [...tmplt.matchAll(/{:.*:}/g)];
            ...
            for (let i = 0; i < embeddedModules.length; i++) {
                ...
                let newId = pModuleInstanceId + "_" + i;
                tmplt = tmplt.replace(embeddedModules[i][0], "<div id='EmbeddedModule_" + newId + "div'></div>");
                ...
                // Todo: this get's called with Grand newId and child embeddedModulesrc (because parent already flattened into grand)
        ...
        fetch ("modules/" + module + "/" + module + ".html").then(function (response) {
            ...
            templateHTML = scanForChildModules(templateHTML, moduleInstanceId);
